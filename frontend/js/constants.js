const contractAddress = "0xe5D0C30cf8beAa4dB08592cFB052216e521660E8"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the SkullzPirates NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The SkullzPirates NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://SkullzPirates.xyz"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
